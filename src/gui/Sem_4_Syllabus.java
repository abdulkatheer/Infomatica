...
public class Sem_4_Syllabus extends javax.swing.JFrame {

    
    public Sem_4_Syllabus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Footer_txt.setBackground(new java.awt.Color(45, 118, 232));
        ...
        dataAnalytics.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        mobileComputing.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        infoSecurity.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        infoCodingTeq.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        fundamentalsOfDSP.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        roboticsAndAutomation.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void minimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeMousePressed
        this.setState(Sem_4_Syllabus.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sem_4_Syllabus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sem_4_Syllabus().setVisible(true);
            }
        });
    }
