...
public class Internal1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MarkTable.setFont(new java.awt.Font("Sitka Small", 0, 14)); // NOI18N
        MarkTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S No.", "Subject Name", "Marks Obtained"
            }
        ) {
        ...
        if (MarkTable.getColumnModel().getColumnCount() > 0) {
            ...
            MarkTable.getColumnModel().getColumn(0).setPreferredWidth(3);
            MarkTable.getColumnModel().getColumn(1).setResizable(false);
            MarkTable.getColumnModel().getColumn(1).setPreferredWidth(40);
            MarkTable.getColumnModel().getColumn(2).setResizable(false);
            MarkTable.getColumnModel().getColumn(2).setPreferredWidth(40);
        }

        jLabel3.setFont(new java.awt.Font("Sitka Heading", 0, 18)); // NOI18N
        jLabel3.setText("Internal - 1 Marks");
    ...
    private void exit1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exit1MousePressed
        this.setState(Internal1.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Internal1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
