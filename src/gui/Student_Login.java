...
public class Student_Login extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        if(Username.getText().isEmpty() && Password.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(null, "Enter Your username first..!!");
            Username.setText("");
            Password.setText("");
        }
            ...
            LoginDriver driver = new LoginDriver(username, password);
            boolean isOkay = driver.check();
            if(isOkay){
                Student_Content s = new Student_Content();
                this.dispose();
                s.setVisible(true);
            }
            else{
    ...
    private void minimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeMousePressed
        this.setState(Student_Login.ICONIFIED);
