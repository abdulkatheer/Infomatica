...
public class SemResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("The Result Has Not Been Published Yet..!!");

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Not Found.png"))); // NOI18N
    ...
    private void exit1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exit1MousePressed
        this.setState(SemResult.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SemResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
