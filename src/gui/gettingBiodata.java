...
public class gettingBiodata extends javax.swing.JFrame {

    
    public gettingBiodata() {
        initComponents();
    }
    ...
    private void exit1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exit1MousePressed
        this.setState(gettingBiodata.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gettingBiodata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gettingBiodata().setVisible(true);
            }
        });
    }
