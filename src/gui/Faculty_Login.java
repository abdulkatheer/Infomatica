...
public class Faculty_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MainPanel.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 860, 40));
        ...
        Password.setFont(new java.awt.Font("Sitka Small", 0, 11)); // NOI18N
    ...
    private void exit1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exit1MousePressed
        this.setState(Faculty_Login.ICONIFIED);
