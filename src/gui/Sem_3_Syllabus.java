...
public class Sem_3_Syllabus extends javax.swing.JFrame {

    
    public Sem_3_Syllabus() {
        initComponents();
    }
    ...
    private void minimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeMousePressed
        this.setState(Sem_3_Syllabus.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sem_3_Syllabus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sem_3_Syllabus().setVisible(true);
            }
        });
    }
